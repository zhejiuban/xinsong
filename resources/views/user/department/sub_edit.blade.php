...
@section('content')
    <div class="m-portlet m--margin-bottom-0">
        ...
        <form class="m-form m-form--label-align-right" action="{{ route('departments.sub.edit',['department'=>$menu->id]) }}" method="post" id="data-form">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <select name="parent_id" id="parent_id" class="form-control select2 m-select2">
                            {!! department_select($menu->parent_id) !!}
                        </select>
                    </div>
                </div>
                <div class="form-group m-form__group row">
