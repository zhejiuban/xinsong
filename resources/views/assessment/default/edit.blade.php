...
<div class="modal-body">
  <form class="m-form" action="{{ route('assessments.update',['assessment'=>$assessment->id]) }}" method="post" id="data-form">
      <div class="form-group">
        <label for="name" class="form-control-label">
          考核人员:
        </label>
        <select name="user_id" class="form-control" id="user_id" data-error-container="#user_id-error">
          <option value="{{$assessment->user_id}}" selected>{{$assessment->user->name}}</option>
        </select>
      ...
      <div class="form-group">
        ...
        <select class="form-control select2" name="assessment_rule_id" id="assessment_rule_id" data-error-container="#assessment_rule_id-error">
          {!! assessment_rule_select($assessment->assessment_rule_id) !!}
        </select>
      ...
      <div class="form-group">
        ...
        <input type="text" name="remark" value="{{ $assessment->remark }}" class="form-control" id="remark">
      </div>
      {{ csrf_field() }}
      {{ method_field('PUT') }}
    </form>
