...
@section('content')
    <div class="m-portlet m-portlet--mobile m--margin-bottom-0">
        ...
        <!--begin::Form-->
        <form action="{{route('paternity_records.update',['paternity_record'=>$malfunction->id])}}" id="malfunction-form" method="post"
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="car_no" class="form-control m-input"
                                   placeholder="请输入AGV编号或其他" value="{{$malfunction->car_no}}">
                            <span class="m-form__help"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control m-input select2" name="is_handle" >
                                {!! is_handle_select($malfunction->is_handle) !!}
                            </select>
                            <span class="m-form__help"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="closed_at" class="form-control m-input m-date"
                                   placeholder="请输入关闭时间" value="{{$malfunction->closed_at}}">
                            <span class="m-form__help"></span>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="question" class="form-control m-input" rows="8"
                                      data-error-container="#question-error" placeholder="请输入现场故障或问题描述">{{$malfunction->question}}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="solution" class="form-control m-input" rows="8"
                                      data-error-container="#solution-error" placeholder="请输入解决过程和办法">{{$malfunction->solution}}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="remark" class="form-control m-input" rows="8"
                                      data-error-container="#remark-error" placeholder="请输入备注">{{$malfunction->remark}}</textarea>
