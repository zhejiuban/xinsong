            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ menu_url_format(route('product_faults.create'),['mid'=>request('mid')]) }}"
                    ...
                    <li class="m-portlet__nav-item">
                        <a href="{{route('product_faults.export',['mid'=>request('mid')])}}"
                           class="btn btn-sm btn-primary m-btn m-btn--icon m-btn--air m-btn--pill">
                            <span>
                    ...
                    {{--<li class="m-portlet__nav-item">
                        <a href="{{ menu_url_format(route('product_faults.destroy'),['mid'=>request('mid')]) }}"
        ...
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right  m--margin-bottom-20">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="m-input-icon m-input-icon--left">
                                <input type="text" class="form-control m-input" placeholder="小车编号..."
                                       id="m_form_search">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <select name="fault_cause_id" class="form-control m-bootstrap-select" id="m_form_status">
                                {!! fault_cause_select() !!}
                            </select>
                        </div>
                    </div>
        ...
        var DatatableAjax = function () {
            ...
            var DataList = function () {
                ...
                datatable = $('.m_datatable').mDatatable({
                    ...
                    data: {
                        ...
                        source: {
                            type: 'get',
                            read: {
                                url: '{{ route("product_faults.index") }}',
                                param: {}
                            }
                        },
                    ...
                    columns: [{
                        ...
                        template: function (row) {
                            return row.project ? row.project.no : null;
                        }
                    },{
                        field: "project_id",
                        title: "所属项目",
                        ...
                        field: "fault_cause_id",
                        title: "故障现象",
                        sortable: false,
                        template: function (row) {
                            return row.fault_cause ? row.fault_cause.name : null;
                        }
                    },  {
                        field: "occurrenced_at",
                        title: "发生时间",
                    }, {
                        field: "user_id",
                        title: "上报人",
                        ...
                        overflow: 'visible',
                        template: function (row) {
                            var del = '<a href="' + mAppExtend.laravelRoute('{{route_uri("product_faults.destroy")}}', {product_fault: row.id,mid:"{{request('mid')}}" }) + '" class="action-delete m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="删除"><i class="la la-trash"></i></a>';
                            var edit = '<a href="' + mAppExtend.laravelRoute('{{route_uri("product_faults.edit")}}', {
                                product_fault: row.id,
                                mid: "{{request('mid')}}"
                ...
                $('#m_form_status').on('change', function () {
                    datatable.search($(this).val(), 'fault_cause_id');
                }).val(typeof query.fault_cause_id !== 'undefined' ? query.fault_cause_id : '');
