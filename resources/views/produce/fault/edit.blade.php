...
@section('content')
    <div class="m-portlet m-portlet--mobile m--margin-bottom-0">
        ...
        <!--begin::Form-->
        <form action="{{route('product_faults.update',['product_fault'=>$fault->id])}}" id="fault-form" method="post"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control m-input select2" id="project_select" name="project_id">
                                <option value="{{$fault->project_id}}"
                                            selected>{{$fault->project ? $fault->project->title : null}}</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="car_no" class="form-control m-input"
                                   placeholder="请输入小车编号" value="{{$fault->car_no}}">
                            <span class="m-form__help"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control m-input select2" name="fault_cause_id" >
                                {!! fault_cause_select($fault->fault_cause_id) !!}
                            </select>
                            <span class="m-form__help"></span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="occurrenced_at" class="form-control m-input m-dates"
                                   placeholder="请输入发生时间" value="{{$fault->occurrenced_at}}">
                            <span class="m-form__help"></span>
                        </div>
                    </div>
...
@section('js')
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            var form = $('#fault-form');
            var submitButton = $("#fault-submit-button");
            form.validate({
