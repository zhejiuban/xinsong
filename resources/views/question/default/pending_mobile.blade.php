...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        <form method="get" action="{{route('question.pending',['mid'=>request('mid')])}}"
                ...
                <div class=" m-form__group row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <a href="{{ route('question.personal.create',['back'=>'personal','mid'=>'33b831058807f08d98879f28b9847613']) }}"
    ...
    <div class="m-portlet m-portlet--mobile " id="question-{{$question->id}}">
        ...
        <div class="m-portlet-action row">
            <div class="btn-group m-btn-group col" role="group" aria-label="">
                ...
                m-btn--icon-center action-show" href="{{route('questions.show',[
                            'question'=>$question->id,'mid'=>request('mid')
                            ])}}">
                    <span>
                        <i class="la la-eye"></i>
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('a.action-reply,a.action-show').click(function (event) {
