...
<div class="modal-body">
  <form class="m-form" action="{{ route('categories.update',['category'=>$category->id]) }}" method="post" id="data-form-edit">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="remark" id="remark" rows="6">{{ $category->remark  }}</textarea>
      </div>
      <div class="form-group">
          <label>
              是否可用:
          ...
          <div class="m-radio-inline">
              <label class="m-radio">
                  <input type="radio" name="status" value="1" {{ $category->status ? 'checked' : '' }}>
                  是
                  <span></span>
              </label>
              <label class="m-radio">
                  <input type="radio" name="status" value="0" {{ $category->status ? '' : 'checked' }}>
                  否
                  <span></span>
              </label>
          </div>
