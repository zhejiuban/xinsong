...
<div class="modal-body">
	<form class="m-form" action="{{ route('plans.store',['project'=>$project]) }}" method="post" id="plans-form">
		<div class="row m-form__group ">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="">
						<input type="number" name="sort" class="form-control m-input" >
					</div>
					<span class="m-form__help"></span>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
		            ...
		            <input type="text" class="form-control m-input m-date" placeholder="计划开始日期" name="started_at" />
					<span class="m-form__help"></span>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		            ...
		            <input type="text" class="form-control m-input m-date" placeholder="计划完成日期" name="finished_at" id="finished_at"/>
					<span class="m-form__help"></span>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="">
						<select class="form-control m-input select2" id="leader" name="user_id">
							{!!project_user_select($project->id)!!}
						</select>
					</div>
			...
			<div class="col-md-6">
				<div class="form-group">
		            ...
		            <input type="text" class="form-control m-input m-date" placeholder="实际完成日期" name="last_finished_at" id="last_finished_at"/>
					<span class="m-form__help"></span>
				</div>
			</div>
			<div id="reason-area" class="col-md-12 hide">
				<div class="form-group">
