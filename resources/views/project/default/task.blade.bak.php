            ...
            <div class="m-portlet m-portlet--full-height  m-portlet--tabs">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
                            <li class="nav-item m-tabs__item m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-left"
                                ...
                                <a href="{{ route('project.tasks',['project_id'=>$project->id,'mid'=>request('mid')]) }}#lists"
                                        ...
                                        <div class="m-dropdown__body">
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="{{ route('project.tasks',['project_id'=>$project->id,'only'=>1,'mid'=>request('mid')]) }}#lists"
                                                           class="m-nav__link">
                                                    ...
                                                    {{--<li class="m-nav__item">--}}
                                                        {{--<a href="{{ route('project.tasks',['project_id'=>$project->id,'date'=>'day','mid'=>request('mid')]) }}#lists"--}}
                                                           {{--class="btn btn-outline-primary m-btn m-btn--pill m-btn--wide btn-sm">--}}
                                                            {{--日--}}
                                                        {{--</a>--}}
                                                        {{--<a href="{{ route('project.tasks',['project_id'=>$project->id,'date'=>'week','mid'=>request('mid')]) }}#lists"--}}
                                                           {{--class="btn btn-outline-primary m-btn m-btn--pill m-btn--wide btn-sm">--}}
                                                            {{--周--}}
                                                        {{--</a>--}}
                                                        {{--<a href="{{ route('project.tasks',['project_id'=>$project->id,'date'=>'month','mid'=>request('mid')]) }}#lists"--}}
                                                           {{--class="btn btn-outline-primary m-btn m-btn--pill m-btn--wide btn-sm">--}}
                                                            {{--月--}}
                                                        {{--</a>--}}
                                                    {{--</li>--}}
                            ...
                            <li class="nav-item m-tabs__item">
                                <a href="{{ route('project.dynamics',['project'=>$project->id,'mid'=>request('mid')]) }}#lists"
                                   class="nav-link m-tabs__link">
                                    日志
                                </a>
                            </li>
                            <li class="nav-item m-tabs__item">
                                <a href="{{ route('project.questions',['project'=>$project->id,'mid'=>request('mid')]) }}#lists"
                                   class="nav-link m-tabs__link">
                                    问题
                                </a>
                            </li>
                            <li class="nav-item m-tabs__item">
                                <a href="{{ route('project.files',['project'=>$project->id,'mid'=>request('mid')]) }}#lists"
                                   class="nav-link m-tabs__link ">
                                    文档
                                </a>
                            </li>
                            <li class="nav-item m-tabs__item">
                                <a href="{{ route('project.users',['project'=>$project->id,'mid'=>request('mid')]) }}#lists"
                                   class="nav-link m-tabs__link ">
                                    参与人
                                </a>
                            </li>
                ...
                <div class="m-portlet__body min-height-300">
                    <div class="m-actions">
                        ...
                        <a href="{{ route('tasks.create',['project_id'=>$project->id,'mid'=>request('mid')]) }}#lists"
