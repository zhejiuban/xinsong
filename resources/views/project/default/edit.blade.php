...
@section('content')
    ...
    <div class="m-portlet m-portlet--tabs  m--margin-bottom-0">
        ...
        <!--begin::Form-->
        <form action="{{route('projects.update',['project'=>$project->id])}}" id="project-form" method="post"
                        ...
                        <div class="row m-form__group">
                            <div class="col-md-6">
                                <div class="form-group  ">
                                    ...
                                    <input type="text" name="title" value="{{$project->title}}"
                                           class="form-control m-input" placeholder="请输入项目名称">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no" value="{{$project->no}}" class="form-control m-input"
                                           placeholder="请输入项目编号">
                                    <span class="m-form__help"></span>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control m-input" id="user_select" name="leader">
                                        @if($project->leaderUser)
                                            <option selected
                                                    value="{{$project->leaderUser->id}}">{{$project->leaderUser->name}}</option>
                                        @endif
                                    </select>
                                    <span class="m-form__help"></span>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control m-input" id="subcompany_leader"
                                        ...
                                        @if($project->companyUser)
                                            <option selected
                                                    value="{{$project->companyUser->id}}">{{$project->companyUser->name}}</option>
                                        @endif
                                    </select>
                                    <span class="m-form__help"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control m-input" id="user_select2" name="agent">
                                        @if($project->agentUser)
                                            <option selected
                                                    value="{{$project->agentUser->id}}">{{$project->agentUser->name}}</option>
                                        @endif
                                    </select>
                                    <span class="m-form__help"></span>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="remark" class="form-control m-input" rows="8"
                                              placeholder="请输入项目描述">{{$project->remark}}</textarea>
                                    <span class="m-form__help"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row m-form__group">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customers" value="{{$project->customers}}"
                                           class="form-control m-input" placeholder="请输入客户对接人">
                                    <span class="m-form__help"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customers_tel" value="{{$project->customers_tel}}"
                                           class="form-control m-input" placeholder="请输入客户对接人电话">
                                    <span class="m-form__help"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customers_address" value="{{$project->customers_address}}"
                                           class="form-control m-input" placeholder="请输入客户地址">
                                    <span class="m-form__help"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane device-list" id="m_tabs_6_2" role="tabpanel">
                        ...
                        @if($project->devices->isNotEmpty())
                            @foreach ($project->devices as $device)
                                <div class="form-group m-form__group row device-option @if ($loop->last) last-device-option @endif"
                                     id="device-option-{{$loop->iteration}}">
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control m-input select2"
                                                name="device_project[{{$loop->iteration}}][device_id]">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="device_project[{{$loop->iteration}}][number]"
                                               value="{{$device->pivot->number}}" class="form-control m-input"
                                               placeholder="请输入设备数量">
                                        <span class="m-form__help"></span>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="">&nbsp;</label>
                                        <div class="">
                                            <button type="button" title="删除" id="del-device-option-{{$loop->iteration}}"
                                                    onclick="delDeviceOption({{$loop->iteration}});"
                                                    device-id="{{$loop->iteration}}"
                                                    class="btn btn-danger del-device-option">
                    ...
                    <div class="tab-pane" id="m_tabs_6_3" role="tabpanel">
                        @if($project->phases->isNotEmpty())
                            @foreach ($project->phases as $phase)
                                <div class="form-group m-form__group row phase-option  @if ($loop->last) last-phase-option @endif"
                                     id="phase-option-{{$loop->iteration}}">
                                    <div class="col-md-1">
                                        <h1>{{$loop->iteration}}</h1>
                                        <input type="hidden" name="project_phases[{{$loop->iteration}}][id]"
                                               value="{{$phase->id}}">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="">建设阶段:</label>
                                        <input type="text" class="form-control m-input" value="{{$phase->name}}"
                                               name="project_phases[{{$loop->iteration}}][name]" readonly>
                                        <span class="m-form__help"></span>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="">开始时间:</label>
                                        <input type="text" name="project_phases[{{$loop->iteration}}][started_at]"
                                               value="{{$phase->started_at}}" class="form-control m-input m-date"
                                               placeholder="请选择时间">
                                        <span class="m-form__help"></span>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="">结束时间:</label>
                                        <input type="text" name="project_phases[{{$loop->iteration}}][finished_at]"
                                               value="{{$phase->finished_at}}" class="form-control m-input  m-date"
                                               placeholder="请选择时间">
                                        <span class="m-form__help"></span>
                                    </div>
                                    <div class="col-md-2" style="display:none;">
                                        ...
                                        <select class="form-control m-input select2"
                                                name="project_phases[{{$loop->iteration}}][status]">
                                ...
                                <div id="file-upload-instance" class="clearfix multi-image-upload">
                                    @if($project->files->isNotEmpty())
                                        @foreach ($project->files as $file)
                                            <div id="uploaded-{{$file->id}}" title="{{$file->old_name}}"
                                                 data-container="body" data-toggle="m-tooltip" data-placement="top"
                                                 data-original-title="{{$file->old_name}}"
                                                ...
                                                <div class="file-item-bg bg-grey-cararra full-height">
                                                    <div class="text-right file-cannel">
                                                        <a href="javascript:;" title="删除"
                                                           data-file-id="uploaded-{{$file->id}}" class="m--font-danger">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
...
@section('js')
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            $("#user_select2,#subcompany_leader").select2({
                language: 'zh-CN',
                placeholder: "输入姓名、用户名等关键字搜索，选择用户",
                allowClear: true,
                width: '100%',
